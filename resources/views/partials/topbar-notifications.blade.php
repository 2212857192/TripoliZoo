<div class="notification-dropdown-wrapper">
    ...
    <div class="notification-dropdown" id="notificationMenu" style="display:none;">
        <h4 style="font-size:0.95rem;font-weight:800;border-bottom:1px solid var(--border);padding-bottom:10px;margin-bottom:12px;color:var(--text-main);display:flex;justify-content:space-between;align-items:center;gap:8px;">
            <span>الإشعارات</span>
            @if(($notificationCount ?? 0) > 0)
                <span id="notificationCountBadge" style="background:#fef2f2;color:#ef4444;font-size:0.7rem;padding:2px 8px;border-radius:20px;">{{ $notificationCount }} جديدة</span>
            @endif
        </h4>
        <div id="notificationItemsList" style="display:flex;flex-direction:column;gap:8px;">
