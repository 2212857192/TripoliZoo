            ...
            <div class="topbar-right">
                ...
                <div class="page-title">
                    ...
                    <div class="breadcrumb">
                        الرعاية والتغذية <span>/</span> @yield('page_title', 'لوحة التحكم')
                    </div>
                </div>
            </div>
            ...
            <div class="topbar-actions">
                <div style="display: flex; align-items: center; gap: 10px; padding-left: 15px; border-left: 1px solid var(--border);">
                    <div style="text-align: left;">
                        <div style="font-size: 0.85rem; font-weight: 800; color: var(--text-main); line-height: 1;">م. أحمد مصطفى</div>
                        <span style="font-size: 0.7rem; color: var(--text-muted); font-weight: 600;">رئيس قسم الرعاية</span>
                    </div>
                    <div style="width:38px; height:38px; border-radius:10px; background:#f1f5f9; color:#1e293b; display:flex; align-items:center; justify-content:center; font-weight:800; font-size:1rem;">م.أ</div>
                </div>
